...
local theme_path = string.format("%s/.config/awesome/themes/%s/theme-edited.lua", os.getenv("HOME"), chosen_theme)
...
globalkeys = my_table.join(
    ...
    awful.key({ modkey }, "h", function() awful.client.focus.bydirection("left") if client.focus then client.focus:raise() end end, {description = "focus left", group = "client"}),
    awful.key({ modkey }, "l", function() awful.client.focus.bydirection("right") if client.focus then client.focus:raise() end end, {description = "focus right", group = "client"}),
    ...
    awful.key({}, "XF86AudioRaiseVolume", function() os.execute("pactl set-sink-volume alsa_output.pci-0000_00_1b.0.analog-stereo +5%") end),
    awful.key({}, "XF86AudioLowerVolume", function() os.execute("pactl set-sink-volume alsa_output.pci-0000_00_1b.0.analog-stereo -5%") end),
    awful.key({}, "XF86AudioMute", function() os.execute("pactl set-sink-mute alsa_output.pci-0000_00_1b.0.analog-stereo toggle") end),

    -- Spotify Control
    awful.key({ altkey, "Control" }, "Up", function () awful.spawn.with_shell("sp play") end),
    awful.key({ altkey, "Control" }, "Down", function () awful.spawn.with_shell("sp pause") end),
    awful.key({ altkey, "Control" }, "Left", function () awful.spawn.with_shell("sp prev") end),
    awful.key({ altkey, "Control" }, "Right", function () awful.spawn.with_shell("sp next") end),
    ...
    -- Brightness
    awful.key({ }, "XF86MonBrightnessUp", function () awful.util.spawn("xbacklight -inc 10") end, {description = "+10%", group = "hotkeys"}),
    ...
    awful.key({ modkey }, "a", function () awful.spawn(guieditor) end, {description = "run gui editor", group = "launcher"}),
